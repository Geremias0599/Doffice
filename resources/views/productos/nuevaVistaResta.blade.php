...
@section("cabecera")
ESTA EN LA SALA DE VENTAS

@endsection

@section("contenido")
    <form class= "formCreacion" method ="POST" action="/addFinalResta/{{$producto->id}}">    
    ...
    @method('PUT')
        <table>
            ...
            <tr>
                <td>UNIDADES EN VENTA : </td>
                <td><input type="text" value="{{$producto->unidadesEnExistencia}}" readonly ></td>
            </tr>
            <tr>
                <td>CANTIDAD QUE COMPRA : </td>
